...
class Head
{
    ...
    public static function init()
    {
        ...
        include_once CLASS_PATH . 'Utils/WingedConfigDefaults.php';
        include_once CLASS_PATH . 'Buffer/Buffer.php';
        include_once CLASS_PATH . 'Date/Microtime.php';
    ...
    "./' . str_replace(DOCUMENT_ROOT, '', $file) . '",';
        ...
        spl_autoload_register(function ($className) {
            ...
            if (class_exists('Winged\Winged')) {
                ...
                if (file_exists(App::$parent . "models/" . $className . ".php")) {
                    include_once App::$parent . "models/" . $className . ".php";
                    return true;
                }
                ...
                if (file_exists(App::$parent . "autoload/" . $className . ".php")) {
                    include_once App::$parent . "autoload/" . $className . ".php";
                    return true;
                }
            }
            findCache($className);
