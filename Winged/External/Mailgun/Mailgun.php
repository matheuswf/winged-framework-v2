...
class Mailgun
{
    ...
    public function validEmail($email = ''){
        $this->clear();
        $this->resquest = new ExternalRequest($this->buildStdBase() . 'address/private/validate', [
            'address' => $email,
            'mailbox_verification' => true,
        ], [
            'type' => 'get',
            'accept' => ExternalRequest::ACCEPT_JSON
        ], false);
    ...
    {
        $this->clear();
        $this->resquest = new ExternalRequest($this->buildBase() . 'messages', $params, [
            'type' => 'post',
            'accept' => ExternalRequest::ACCEPT_JSON
        ], false);
        return $this->resquest->send()->output();
    ...
    {
        $this->clear();
        $this->resquest = new ExternalRequest($this->buildStdBase() . 'domains/' . $this->domain . '/webhooks', [], [
            'type' => 'get',
            'accept' => ExternalRequest::ACCEPT_JSON
        ], false);
