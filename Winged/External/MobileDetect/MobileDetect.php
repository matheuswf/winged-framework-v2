...
namespace Winged\External\MobileDetect;
...
class MobileDetect
{
    ...
    public function setHttpHeaders($httpHeaders = null)
    {
        ...
        if (!is_array($httpHeaders) || !count7($httpHeaders)) {
            $httpHeaders = $_SERVER;
        }
    ...
    public function setCfHeaders($cfHeaders = null)
    {
        ...
        if (!is_array($cfHeaders) || !count7($cfHeaders)) {
            $cfHeaders = $_SERVER;
        }
    ...
    /**
     * @var bool | MobileDetect
     */
    public static $self = false;

    public static function init()
    {
        self::$self = new MobileDetect();
    }

    public static function mobile()
    {
        return self::$self->isMobile();
    }

    public static function tablet()
    {
        return self::$self->isTablet();
    }
