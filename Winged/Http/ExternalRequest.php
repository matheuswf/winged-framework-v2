...
class ExternalRequest
{
    ...
    public function build($url = false, $params = [], $options = [], $ssl_verifypeer = false)
    {
        $this->ioptions = [
            ...
            'parseResponse' => ExternalRequest::PARSE_RESPONSE_YES,
            'contentType' => ExternalRequest::REQUEST_IS_X_WWW_FORM_URLENCODED,
            'charsetRequest' => ExternalRequest::CHARSET_REQUEST,
            'accept' => ExternalRequest::ACCEPT_ALL,
            'type' => ExternalRequest::REQUEST_GET,
            'ignoreHeaders' => false,
        ];
    ...
    public function send()
    {
        if ($this->ch) {
            ...
            return new ExternalResponse($this->ch, $this);
        }
        return null;
    }
